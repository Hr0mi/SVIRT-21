...
mozhaevad-netology-db:
 ...
 container_name: mozhaevad-netology-db # Имя, которым будет называться наш контейнер
 ports: # Порты, которые мы пробрасываем с нашего докер сервера внутрь контейнера
 - 5432:5432
 volumes: # Папка, которую мы пробросим с докер сервера внутрь контейнера
 - ./pg_data:/var/lib/postgresql/data/pgdata
 environment: # Переменные среды
 POSTGRES_PASSWORD: mozhevad # Задаём пароль от пользователя postgres
 POSTGRES_DB: mozhaevad_netology_db # БД которая сразу же будет создана
