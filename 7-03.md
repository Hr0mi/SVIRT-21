# Домашнее задание к занятию «Подъём инфраструктуры в Yandex Cloud» Можаев Андрей
 ...
 users:
  - name: user
    ...
    ssh-authorized-keys:
      - ssh-rsa  xxx
```
![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/f98c4bbf-fee5-485a-abc3-5132eb0fce71)
...
```
![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/3bc331ec-6e5d-4ce1-89c4-a8ad7db4ba70)
...
- hosts: 138.68.85.196
  ...
  tasks:
    - service:
      ...
      become_method: sudo
```
![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/29f6a017-3ef4-43eb-80d5-02e98ef3aa62)

![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/205612a7-f0f0-4b29-951d-4a7f9494799f)

![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/fe5602bc-3ff1-420b-8de0-e8881764a848)


Провести тестирование. 

![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/3653946d-61f5-4737-a5ed-46a7e2b45f43)


![image](https://github.com/Hr0mi/SVIRT-21/assets/95475785/c79016f8-c4ec-4ae3-afbc-645b7f75cc5d)
